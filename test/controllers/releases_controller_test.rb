...
class ReleasesControllerTest < ActionController::TestCase
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post :create, release: { major: @release.major, minor: @release.minor, patch: @release.patch, release_date: @release.release_date }
    end
  ...
  test "should update release" do
    patch :update, id: @release, release: { major: @release.major, minor: @release.minor, patch: @release.patch, release_date: @release.release_date }
    assert_redirected_to release_path(assigns(:release))
  end
